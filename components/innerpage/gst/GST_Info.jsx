          ...
          <div className="col-lg-8">
            <div className="info wow fadeInUp slow" data-wow-delay="0.2s">
              <div className="text fsz-25 fw-500 mb-20">
                ...
                nation right now. Real Estate in India in the current past has
                seen an incredible development, not simply in the Tier 1 urban
                areas, but rather even Tier 2 and Tier 3 urban communities and
                towns. The industry is in the cusp of expanded controls, with
              ...
              <div className="text fsz-25 fw-500 mb-20">
                ...
                regarding macroeconomic conditions and financial strategy
                choices. One such challenge is the administration of the
                numerous roundabout indirect tax levies, for example, VAT,
                Service Tax, excise, stamp duty and registration fees.
              </div>
            </div>
          </div>
