          ...
          <div className="col-lg-8">
            <div className="info wow fadeInUp slow" data-wow-delay="0.2s">
              <div className="text fsz-20 fw-500 mb-20">
                ...
                to the Maharashtra stamp act 1958. Without the payment of this
                stamp duty, your solicitor will not be able to officially
                register your new house in your name, even when the house is
                transferred within the family. The rate of stamp duty for
                galas/office/shop premises and garage even if just used for car
              ...
              <div className="text fsz-20 fw-500 mb-20">
                ...
                jurisdiction under which the property is located. The purchaser
                officially becomes the legal owner of the property, only after
                the title deeds are registered or recorded in his/her name.
              </div>
            </div>
          </div>
