                      ...
                      >
                        <div className="accordion-body">
                          <div className="text">
                            ...
                            elit. Nisi provident labore maiores nobis? Corporis,
                            dolore suscipit! Magni repudiandae voluptatum
                            corporis animi voluptatem, quibusdam enim laudantium
                            unde iure dicta, ea labore!
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <div className="text">
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Explicabo magni tempore voluptatem
                            exercitationem! Quibusdam rerum quidem, dolorum ea
                            quos nisi deserunt accusantium fuga atque quaerat
                            voluptas impedit, cum officiis explicabo.
                          </div>
                        </div>
                      </div>
                    </div>
