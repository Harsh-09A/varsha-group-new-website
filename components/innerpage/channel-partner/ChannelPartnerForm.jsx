            ...
            >
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="form-group mb-30">
                    <label htmlFor="">
                      Select Type Of The Organisation <span className="color-orange1"> * </span>
                    </label>
                    <select name="" id="" className="form-select form-control">
                      <option value="">Select Type Of The Organisation</option>
                      <option value=""> Individual Proprietorship </option>
                      <option value=""> Partnership Company </option>
